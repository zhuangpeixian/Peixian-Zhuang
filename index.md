...
9. Two papers titled “Pan-GGF: A Probabilistic Method for Pan-sharpening With Gradient Domain Guided Image Filtering” and “MRI Reconstruction with an Edge-Preserving Prior” have been accepted on Signal Processing (信号处理类TOP期刊，SCI JCR 1区, CCF推荐, IF：4.086) ！
10. One paper titled “Underwater Image Enhancement Using a Multi-Scale Dense Generative Adversarial Network” has been accepted on IEEE Journal of Oceanic Engineering (海洋工程类TOP期刊, SCI JCR 2区, IF：2. 435) !
...
5.	**Peixian Zhuang***, Xiaowen Zhu, and Xinghao Ding.  MRI Reconstruction with an Edge-Preserving Filtering Prior. Signal Processing, vol. 155, pp. 346-357, 2019. (信号处理类TOP期刊，SCI, JCR1, CCF推荐, IF: 3.470) 
6.	**Peixian Zhuang***, Qingshan Liu, and Xinghao Ding. Pan-GGF: A Probabilistic Method for Pan-Sharpening With Gradient Domain Guided Image Filtering. Signal Processing, vol. 156, pp. 177-190, 2019. (信号处理类TOP期刊，SCI, JCR1, CCF推荐, IF: 3.470) 
...
8.	**Peixian Zhuang***, and Xinghao Ding. Underwater Image Enhancement Using An Edge-Preserving Filtering Retinex Algorithm. Multimedia Tools and Applications, vol. 79, pp. 17257–17277, 2020. (SCI, JCR4, CCF推荐, IF: 2.101)
9.	Yecai Guo*, Haiyu Li, and **Peixian Zhuang**. Underwater Image Enhancement Using a Multi-Scale Dense Generative Adversarial Network. IEEE Journal of Ocean Engineering, pp. 1-9, 2019. (海洋工程类TOP期刊, SCI, JCR2, IF: 2.435)
